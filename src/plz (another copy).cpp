...
void ImageLiDARFusion::set_param()
{
  ...
  // Mat Rlc = (Mat_<double>(3,3) << 
  // -0.03636605,  0.99823715,  0.04690534,
  // 0.13945242,  0.05154625, -0.98888624,
  // -0.98956078, -0.02942083, -0.14108112);


  // Mat Tlc = (Mat_<double>(3,1) << 
  // -0.14528063, -0.05835783, 1.84488955);
